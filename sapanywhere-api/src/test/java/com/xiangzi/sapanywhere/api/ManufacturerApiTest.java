...
public class ManufacturerApiTest extends BaseAnywhereTest {
	...
	@Test
	public void count() {
		int count = manufacturerApi.count(accessToken.getValue());
	...
	public void pager() {
		...
		pager = manufacturerApi.pager(accessToken.getValue(), pager);
		...
		List<Manufacturer> list = (List<Manufacturer>) pager.getList();
		logger.info("list.size:" + list.size());
		logger.info("list.json:" + JSONUtil.toJSONString(list));

		for (Manufacturer manufacturer : list) {
			logger.info("manufacturer.json:" + JSONUtil.toJSONString(manufacturer));
		}
